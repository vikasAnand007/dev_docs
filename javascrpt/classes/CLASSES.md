...
- Private fields/methods and not passed to sub class when extended. That means declaring another field with same name in child class wont affect field in parent class.
...
- these are also passed to child class when extended from.
